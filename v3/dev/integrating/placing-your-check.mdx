...
<Tip>
  Building a native app instead of a web page? Use the [Mobile SDKs](/v3/dev/spec/mobile-sdk/vycheck)
  instead of this page. `vycheck()` opens the same hosted flow full screen on iOS, Android, and React
  Native, with no iframe and no origin to register.
</Tip>
