...
description: "Open the session with vycheck() and hand the token to your server."
---
...
<Tabs>
  <Tab title="Browser">
    ...
    If you are not sure which of your hosts to send, open the page where the check appears and read
  ...
  <Tab title="Android">
    Full screen, no redirect, no iframe: the SDK opens native chrome it owns. Call `vycheck()` once; the result arrives through callbacks.
    ...
    Options and examples: [`vycheck()`](/v3/dev/spec/mobile-sdk/vycheck). What a rejection looks like: [Errors](/v3/dev/spec/mobile-sdk/errors).
  </Tab>
  <Tab title="iOS">
    Full screen, no redirect, no iframe: the SDK opens native chrome it owns. Call `vycheck()` once; the result arrives through callbacks.
  ...
  <Tab title="React Native">
    Full screen, no redirect, no iframe: the SDK opens native chrome it owns. Call `vycheck()` once; the result arrives through callbacks, and the returned promise settles too.
