...
With a `session_id` back, move to [Placing your check](/v3/dev/integrating/placing-your-check)
for the browser SDK, or the [Mobile SDKs](/v3/dev/spec/mobile-sdk/vycheck) for iOS, Android, or
React Native. Both open the same session.
