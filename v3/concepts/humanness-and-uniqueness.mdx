...
Humanness is a short, guided **face check** using the device camera. The person centers their face in an oval and holds steady for a few seconds. That is the whole thing: about ten seconds, no documents, no license or passport uploads.
