...
- **Re-run the same call.** Send returning users through the same [`vycheck()`](/v3/dev/spec/browser-sdk/vycheck) or [`initialize`](/v3/dev/spec/server-api/initialize) entry point. A recognized human passes through quickly instead of starting over.
