...
<AccordionGroup>
  ...
  <Accordion title="How do I tie a verification to my own user?">
    ...
    [initialize](/v3/dev/spec/server-api/initialize) from your server. The `external_id` comes
  ...
  <Accordion title="I have a one-time form and don't want resubmissions. What do I use?">
    Usually **not** lock. Store the confirmation `id` you were returned and refuse
    to accept the same one twice. That stops a resubmission without affecting the
