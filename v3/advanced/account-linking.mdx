...
Pass `external_id` to associate the session with a record on your side. It comes straight back when you [confirm](/v3/dev/spec/server-api/confirmations), so you can match the verified human to your user without a lookup table.
