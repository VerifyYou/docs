...
<Steps>
  ...
  <Step title="We verify them">
    ...
    1. **Phone number check** — a verified phone number acts as a persistent identifier that follows the user across devices, browsers, and sessions. Returning users skip the full flow.
