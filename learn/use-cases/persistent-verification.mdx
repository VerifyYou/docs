...
canonical: "/docs/use-cases/persistent-verification"
...
{/*
LITERAL COPY of docs/use-cases/persistent-verification.mdx. THE DOCS PAGE IS THE SOURCE.
*/}
...
5. **The history sits on the person.** Every confirmation they appear in, newest first, with the devices we know them on and what they have proven. Your server can [ask where somebody stands](/v3/dev/spec/server-api/lookup) by email or phone, without starting a new run.
